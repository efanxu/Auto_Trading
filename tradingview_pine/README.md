...
2. Or clone this repo and open `tradingview_pine/MRT.pine` in your editor.
...
1. Add `tradingview_pine/MRT.pine` to a **15m** chart. The script intentionally errors on other chart timeframes.
